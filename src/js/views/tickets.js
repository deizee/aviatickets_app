...
class TicketsUI {
    constructor(currency) {
        ...
        this.getCurrencySymbol = currency.getCurrencySymbol.bind(currency); // забайндили, т.к. теряется контекст
        this.favoriteAddBtnClass = '.add-favorite';
    }
    ...
    static ticketTemplate(ticket, currency) {
      ...
      <div class="card ticket-card" data-ticket-id="${ticket._id}">
        ...
        <a
          class="transparent add-favorite ml-auto"
          ><i class="material-icons favorite-icon favorite-${ticket.isFavorite}"></i></a
        >
      </div>
    </div>
        `;
